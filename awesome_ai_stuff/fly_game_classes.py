...
#     def __init__(self) -> None:
#         self.red = Agent(RED,start_pos.copy(),time)
#         self.blue = Agent(BLUE,Vector2(-start_pos.x,start_pos.y),time)
#         self.it = RED
#         self.was_t = False
#         self.winner = None
...
#         self.blue.update()
#         self.red.update()
#         self.blue.pos.x = min(max(self.blue.pos.x,0),area_w)
#         self.blue.pos.y = min(max(self.blue.pos.y,0),area_h)
#         self.red.pos.x = min(max(self.blue.pos.x,0),area_w)
#         self.red.pos.y = min(max(self.blue.pos.y,0),area_h)
#         if self.blue.pos.distance_squared_to(self.red.pos) < player_size_s:
#             if not self.was_t:
#                 if self.it == BLUE:
#                     self.it = RED
#                 else:
...
#     def __init__(self, color, pos, time) -> None:
#         self.pos = pos
#         self.color = color
...
#     def left_input(self):
#         self.vel += Vector2(-move_speed,0)
    
#     def right_input(self):
#         self.vel += Vector2(move_speed,0)
    
#     def up_input(self):
#         self.vel += Vector2(0,thrust)
    
#     def update(self):
#         self.pos += self.vel
#         self.vel *= friction
#         self.vel += Vector2(0,grav)